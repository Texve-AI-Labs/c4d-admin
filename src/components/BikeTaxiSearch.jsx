...
const BikeTaxiSearch = ({ onSearch, initialValue = '', hideAddNewButton=false }) => {
      ...
      <div className="flex items-center justify-between">
        <div className="relative flex-grow max-w-[500px]">
          <input
            ...
            placeholder="Search Bike Taxi Owner"
            value={searchQuery}
        ...
        {!hideAddNewButton && ( 
        <button 
          onClick={() => navigate("/dashboard/vendors/account/owner-onboarding-bike-taxi/add")}
