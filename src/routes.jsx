...
import { VendorManagementOrdersAdd } from "./pages/vendorManagement/orders/add";
import { VendorManagementOrdersEdit } from "./pages/vendorManagement/orders/edit";
...
export const routes = [
  {
    ...
    pages: [
      ...
      {
        icon: <UserIcon {...icon} />,
        name: "Vendor Management Orders Add",
        path: "/vendor-management/orders/add",
        element: <VendorManagementOrdersAdd />,
        display: false,
        permission: "Vendor Management",
      },
      {
        icon: <UserIcon {...icon} />,
        name: "Vendor Management Orders Edit",
        path: "/vendor-management/orders/edit/:id",
        element: <VendorManagementOrdersEdit />,
        display: false,
        permission: "Vendor Management",
      },
      {
