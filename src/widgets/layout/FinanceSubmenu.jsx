...
const FINANCE_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Driver Estimation & Request control", path: "/dashboard/finance/category-driver-eligible", requiredPermission: "Users" },
    ],
  },
  {
    title: "Rewards",
...
const ROUTE_MATCHERS = {
  ...
  "Driver Estimation & Request control": ["/finance/category-driver-eligible"],
