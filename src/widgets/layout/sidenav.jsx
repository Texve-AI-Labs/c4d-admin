...
const menuItems = [
  ...
  { type: "item", name: "Vendor Management", path: "/dashboard/vendor-management", permission: "Vendor Management" },
  ...
  const isMenuSectionActive = (name, isActive) => {
    ...
    switch (name) {
      ...
      case "Vendor Management":
        return currentPath.startsWith("/dashboard/vendor-management/vendors");
      case "Reports":
