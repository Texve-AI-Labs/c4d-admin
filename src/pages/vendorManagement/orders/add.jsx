...
export const VendorManagementOrdersAdd = () => {
  ...
  const onSubmit = async (values, { setSubmitting }) => {
    try {
      await ApiRequestUtils.post(API_ROUTES.ADD_ORDER, {
  ...
  return (
    <Card className="mx-auto mt-8 w-full max-w-5xl">
      <CardBody>
        <div className="mb-6 text-left text-xl font-bold text-black">Add Order</div>
...
export default VendorManagementOrdersAdd;
