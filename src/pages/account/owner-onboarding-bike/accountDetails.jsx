...
const AccountOnboardingDetails = () => {
  ...
  const handleContinue = () => {
    ...
    navigate(`/dashboard/vendors/account/owner-onboarding-bike/details/vehicle/${id}`);
  };
                ...
                <div className="flex justify-center gap-3 mt-4 flex-wrap">
                  {["APPROVED", "NOT_INTERESTED", "NO_RESPONSE", "INVALID", "DECLINED"].map((nextStatus) => (
                    <button
                      ...
                      className={`px-3 py-1 rounded-md text-white disabled:opacity-60 text-xs ${nextStatus === "APPROVED"
