...
const BikeTaxiAccountDocuments = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const accountDocsRes = await ApiRequestUtils.getWithQueryParam(API_ROUTES.ADMIN_REQUIRED_DOCUMENTS, {
        subjectType: "ACCOUNT",
        serviceType: accountData?.type || "Bike",
      });
      ...
      <div className="flex flex-row mt-4">
        ...
        <Button
          ...
          onClick={async () => {
            ...
            navigate(`/dashboard/vendors/account/owner-onboarding-bike-taxi/vehicle-documents/${id}`);
          }}
...
export default BikeTaxiAccountDocuments;
