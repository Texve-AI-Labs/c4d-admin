...
const normalizeSubType = () => "Bike";

const BikeTaxiVehicleDocuments = () => {
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md">
      <BikeTaxiAccountCreationTabs activeStage={3} />
      <div className="mb-4">
      ...
      <div className="flex flex-row mt-4">
        <Button
          fullWidth
          onClick={() => navigate(`/dashboard/vendors/account/owner-onboarding-bike-taxi/documents/${id}`)}
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigate(`/dashboard/vendors/account/owner-onboarding-bike-taxi/vehicle-creation/${id}`, {
              state: {
                ownerName: account?.name || "",
                type: account?.type || "Bike",
                accountId,
                fromDetails: true,
...
export default BikeTaxiVehicleDocuments;
