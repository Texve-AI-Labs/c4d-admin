...
const BikeTaxiVehicleInfoSection = ({
  ...
  const editableLabels = useMemo(
    () => new Set(["Vehicle Name", "Bike Number", "Address", "Insurance Expiry Date", "Vehicle Type", "Model Year", "Seater"]),
    []
  );
  ...
  const leftDisplayOrder = useMemo(
    () => ["Vehicle Name", "Bike Number", "Address", "Insurance Expiry Date", "Vehicle Type", "Model Year", "Seater"],
    []
  );
...
export default BikeTaxiVehicleInfoSection;
