                ...
                <div key={row?.id || index} className="rounded-lg border border-blue-gray-50 bg-white p-4 shadow-sm">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div className="min-w-0">
                      <Typography variant="small" className="font-semibold text-blue-gray-900 break-words">
                        {formatValue(row?.vehicleNumber)}
                      </Typography>
                      <Typography variant="small" className="text-blue-gray-600 break-words">
                        {formatValue(row?.driverName)}
                      </Typography>
                    </div>
