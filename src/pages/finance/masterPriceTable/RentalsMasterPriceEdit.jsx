    ...
    const onSubmit = async (values) => {
        try {
            const reqBody = {
                ...
                tollCharge: toNumber(values.tollCharge),
                driverCharge: toNumber(values.driverCharge),
                ...
                priceMVP: toNumber(values.priceMVP),
                priceSuv: toNumber(values.priceSuv),
                freeExtraMinutes: toNumber(values.freeExtraMinutes),
                priceSedan: toNumber(values.priceSedan),
                ...
                kilometerRoundPrice: toNumber(values.kilometerRoundPrice),
                kilometerRoundPriceMVP: toNumber(values.kilometerRoundPriceMVP),
                kilometerRoundPriceSuv: toNumber(values.kilometerRoundPriceSuv),
                kilometerRoundPriceSedan: toNumber(values.kilometerRoundPriceSedan),

                extraKilometerPrice: toNumber(values.extraKilometerPrice),
                extraKilometerPriceMVP: toNumber(values.extraKilometerPriceMVP),
                extraKilometerPriceSuv: toNumber(values.extraKilometerPriceSuv),
                extraKilometerPriceSedan: toNumber(values.extraKilometerPriceSedan),

                extraKilometerRoundPrice: toNumber(values.extraKilometerRoundPrice),
                extraKilometerRoundPriceMVP: toNumber(values.extraKilometerRoundPriceMVP),
                extraKilometerRoundPriceSuv: toNumber(values.extraKilometerRoundPriceSuv),
                extraKilometerRoundPriceSedan: toNumber(values.extraKilometerRoundPriceSedan),

                acKilometerPrice: values.type === 'Local' ? toNumber(values.kilometerPrice) : toNumber(values.acKilometerPrice),
                acKilometerPriceMVP: values.type === 'Local' ? toNumber(values.kilometerPriceMVP) : toNumber(values.acKilometerPriceMVP),
                acKilometerPriceSuv: values.type === 'Local' ? toNumber(values.kilometerPriceSuv) : toNumber(values.acKilometerPriceSuv),
                acKilometerPriceSedan: values.type === 'Local' ? toNumber(values.kilometerPriceSedan) : toNumber(values.acKilometerPriceSedan),

                acKilometerRoundPrice: toNumber(values.acKilometerRoundPrice),
                acKilometerRoundPriceMVP: toNumber(values.acKilometerRoundPriceMVP),
                acKilometerRoundPriceSuv: toNumber(values.acKilometerRoundPriceSuv),
                acKilometerRoundPriceSedan: toNumber(values.acKilometerRoundPriceSedan),

                acExtraKilometerPrice: toNumber(values.acExtraKilometerPrice),
                acExtraKilometerPriceMVP: toNumber(values.acExtraKilometerPriceMVP),
                acExtraKilometerPriceSuv: toNumber(values.acExtraKilometerPriceSuv),
                acExtraKilometerPriceSedan: toNumber(values.acExtraKilometerPriceSedan),

                acExtraKilometerRoundPrice: toNumber(values.acExtraKilometerRoundPrice),
                acExtraKilometerRoundPriceMVP: toNumber(values.acExtraKilometerRoundPriceMVP),
                acExtraKilometerRoundPriceSuv: toNumber(values.acExtraKilometerRoundPriceSuv),
                acExtraKilometerRoundPriceSedan: toNumber(values.acExtraKilometerRoundPriceSedan),
