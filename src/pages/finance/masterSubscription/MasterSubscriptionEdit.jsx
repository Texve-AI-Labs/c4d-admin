          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              {values.assignmentType === "TIER" ? (
                ...
                <Field type="text" name="assignmentValue" className="mt-1 p-2 w-full rounded-md border-2 border-gray-300 shadow-sm" disabled placeholder={`Enter ${values.assignmentType === "DRIVER_ID" ? "Driver ID" : values.assignmentType === "CAB_ID" ? "Cab ID" : values.assignmentType === "BIKE_ID" ? "Bike ID" : "Auto ID"}`} />
              }
